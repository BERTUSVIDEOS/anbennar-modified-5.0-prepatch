...
NDefines.NDiplomacyAE_THREATEN_WAR = 0.50               --1.0→0.50
...
NDefines.NMilitary.CAWA_USES_CONSTRUCTION = 0	--0→0
NDefines.NMilitary.CAWA_STARTING_STRENGTH = 0.1 				-- 0.5→0.1
...
NDefines.NMilitary.MERCENARY_COMPANY_MIN_REGIMENTS = 20	--4→20-- Maximum regiments
NDefines.NMilitary.MERCENARY_COMPANY_MANPOWER_PER_REGIMENT = 1.25	--2.0→1.25-- Manpower reserve factor (multiplied by 1000 per regiment)
...
NDefines.NMilitary.NAVAL_BASE_DISENGAGEMENT_CHANCE = 0.2	--0.1→0.2-- Chance of disengaging from naval battles every day when out of morale 0-1 range
...
NDefines.NMilitary.CREATE_HUSSARS_MIL_COST = 20 --0→20
